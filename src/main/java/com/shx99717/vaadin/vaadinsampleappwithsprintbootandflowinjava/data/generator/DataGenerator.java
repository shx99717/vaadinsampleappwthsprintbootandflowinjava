package com.shx99717.vaadin.vaadinsampleappwithsprintbootandflowinjava.data.generator;

import com.vaadin.flow.spring.annotation.SpringComponent;

import com.shx99717.vaadin.vaadinsampleappwithsprintbootandflowinjava.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(SamplePersonRepository samplePersonRepository) {
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2021, 8, 1, 0, 0, 0));
